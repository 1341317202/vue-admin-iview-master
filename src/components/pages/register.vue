  ...
  <div id="app" class="type" :style="{background:'url('+bgUrl+')'}">
    <Row class="bg" :style="{background:'url('+bgUrl+')'}">
      ...
      <Card style="margin: 100px auto;max-width: 600px;padding-top: 20px;text-align: left">
        ...
        <small style="display: block;text-align: center;line-height: 30px;"><img :src="require('@/assets/img/logo1.png')" height="30" alt="" style="vertical-align: top"><span>Copyright by Artiely ,All rights reserved</span>
        </small>
      </Card>
      </Col>
    </Row>
